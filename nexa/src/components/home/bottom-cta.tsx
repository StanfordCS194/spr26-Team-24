    ...
    <section className="w-full px-6 py-12">
      <div className="mx-auto max-w-[1440px]">
        <div className="rounded-2xl bg-[var(--ep-cta-bg)] px-8 py-20 text-center lg:px-16">
          <span className="section-label !text-white/50">/ Get Started</span>
          <h2 className="mt-4 text-3xl font-normal leading-[1.15] tracking-tight text-white sm:text-4xl lg:text-5xl">
            See a problem?
            <br />
